...
With [Upptime](https://upptime.js.org), you can get your own unlimited and free uptime monitor and status page, powered entirely by a GitHub repository. We use [Issues](https://github.com/FuzzyGrim/uptime-monitor/issues) as incident reports, [Actions](https://github.com/FuzzyGrim/uptime-monitor/actions) as uptime monitors, and [Pages](https://FuzzyGrim.github.io/uptime-monitor) for the status page.
